                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#face_with_icon_title" data-toggle="tab" aria-expanded="true">
                                        <i class="material-icons">home</i> UPDATE PROFILE
                                    </a>
                                </li>
                                <li role="presentation" class="">
                                    <a href="#change_password_icon_title" data-toggle="tab" aria-expanded="false">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="face_with_icon_title">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                name="name" class="form-control" placeholder="Enter your name" value="{{Auth::user()->name}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="email_address_2" name="email" class="form-control" placeholder="Enter your email address" value="{{Auth::user()->email}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="change_password_icon_title">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                name="old_password" class="form-control" placeholder="Enter your old password">
                                            </div>
                                        </div>
                                    </div>
                                </div>
